...
const Card = () => {
  return (
    <div className="rounded-2xl bg-neutral-400 dark:bg-neutral-800 py-2 px-4 flex items-center gap-2">
      <img src={COMPANIES.nvda} alt="" className="size-12" />
      <div className="flex flex-col justify-between flex-1">
        <div className="flex flex-col">
          <h5 className="font-semibold text-neutral-200 uppercase">NVDA</h5>
          <p className="text-sm text-neutral-400">NVIDIA Corporation</p>
        </div>
        <p className="text-sm text-neutral-400">Market Cap: $1.00t</p>
      </div>
      <div className="flex flex-col">
        <p className="font-semibold text-neutral-200">+$1,234.56</p>
